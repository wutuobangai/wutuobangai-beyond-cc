...
我自己在用的还有一批——防幻觉护栏、主席台调度规则、竞品对标五层挖法、收口沉淀清单……会一个个脱敏后放上来。

这一页会一直更新。**你也可以告诉我你最想要哪个，我优先开源。**

---

*我是个 30 岁不懂代码的普通人，靠这些自己焊出来的小工具，把一家公司交给了一群 AI 在跑。想直接用上更省事的 → [来 AIGC 站按积分用](https://wutuobangai.com)，或加我微信，咱们当朋友聊。*
